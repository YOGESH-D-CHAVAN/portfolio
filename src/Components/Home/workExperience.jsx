...
const TimelineCard = ({ exp, index }) => {
  ...
  return (
    <article className={`relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group`}>
      ...
      <div className={`flex items-center w-full md:w-[calc(50%-40px)] pl-10 md:pl-0 ${isOdd ? 'justify-start' : 'justify-end'}`}>
        <motion.div
          ...
          className={`w-full bg-white p-6 md:p-8 rounded-2xl border border-stone-100 shadow-sm hover:shadow-xl transition-shadow duration-300 relative z-10 neon-border-card
                ...
                ${isOdd ? 'before:-left-2 md:before:-left-2' : 'before:-left-2 md:before:hidden md:hover:before:block md:before:-right-2 md:before:border-t md:before:border-r'}
...
export default function Experience() {
  ...
  return (
    <section id="experience" ref={containerRef} className="py-24 bg-stone-50/50 relative overflow-hidden scroll-mt-24">
      <motion.div
