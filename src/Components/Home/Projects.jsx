  ...
  return (
    <div ref={container} className="h-screen flex items-center justify-center sticky top-0">
      <motion.article
        ...
        className="flex flex-col relative -top-[5%] md:-top-[5%] w-[92vw] sm:w-[90vw] md:w-[1000px] h-[75vh] sm:h-[70vh] md:h-[500px] rounded-3xl overflow-hidden border border-stone-200 shadow-2xl origin-top bg-white neon-border-card cursor-pointer group"
      >
        <div className="flex flex-col md:flex-row h-full w-full">

          {/* Left: Content */}
          <div className="w-full md:w-[40%] p-6 sm:p-8 md:p-12 flex flex-col justify-between bg-white relative z-20">
...
export default function Projects() {
  ...
  return (
    <div ref={container} className="relative bg-stone-50 scroll-mt-24" id="projects">
      <motion.div
