...
"[project]/src/Components/layouts/Header.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Header.useEffect": ()=>{
            ...
            const observeSections = {
                "Header.useEffect.observeSections": ()=>{
                    const sectionElements = navLinks.map({
                        "Header.useEffect.observeSections.sectionElements": (link)=>document.querySelector(link.href)
                    }["Header.useEffect.observeSections.sectionElements"]);
                    const allFound = sectionElements.every({
                        "Header.useEffect.observeSections.allFound": (el)=>el !== null
                    }["Header.useEffect.observeSections.allFound"]);
                    if (allFound) {
                        observer = new IntersectionObserver({
                            "Header.useEffect.observeSections": (entries)=>{
                                entries.forEach({
                                    "Header.useEffect.observeSections": (entry)=>{
                        ...
                        sectionElements.forEach({
                            "Header.useEffect.observeSections": (section)=>section && observer.observe(section)
                        }["Header.useEffect.observeSections"]);
                        return true; // Success
                    }
            ...
            if (!observeSections()) {
                ...
                const intervalId = setInterval({
                    "Header.useEffect.intervalId": ()=>{
                        if (observeSections()) {
                            clearInterval(intervalId);
                        }
                    }
                }["Header.useEffect.intervalId"], 500);
                return ({
                    "Header.useEffect": ()=>{
                        clearInterval(intervalId);
...
_s(Header, "3MOcZ/thgqWcXyEFq1DZyoY4pxU=", false, function() {
    return [
...
"[project]/src/Components/layouts/Footer.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Footer() {
    ...
    const socialLinks = [
        {
            icon: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$icons$2f$fi$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FiGithub"],
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Footer.useEffect": ()=>{
            const handleScroll = {
                "Footer.useEffect.handleScroll": ()=>setShowScrollTop(window.scrollY > 500)
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$icons$2f$fi$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FiTerminal"], {
                                                        className: "text-emerald-500"
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/Components/layouts/Footer.jsx",
                                                        lineNumber: 109,
...
_s(Footer, "BzYVmYs5YvbcgH1VcNXhMt9CQ6o=");
_c = Footer;
var _c;
...
//# sourceMappingURL=src_Components_832038dd._.js.map